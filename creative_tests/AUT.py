...
class SimpleAlternativesUseTask():
    ...
    def get_AUT_prompt(self, object):
        ...
        if self.standard_prompt:
            return (
                f"List exactly {self.n_uses} alternative uses for a {object}. "
